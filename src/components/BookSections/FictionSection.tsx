...
interface FictionSectionProps {
    subject?: string;
};

const FictionSection: React.FC<FictionSectionProps> = ({ subject = 'fiction' }) => {
    ...
    return (
        <div className="py-16">
            <div className="py-10 flex flex-col gap-6">
                {/* Categories */}
                <h1 className="text-5xl text-on-surface text-center font-bold">{t('categories.fiction')}</h1>
                {/* Header */}
